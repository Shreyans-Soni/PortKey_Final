	...
	<body>
		...
		<!-- Header -->
			<div id="header">
				...
				<p>A Cab Support web portal designed by <a href="http://html5up.net">heart</a>
				<br />
				and released for testing under the <a href="http://html5up.net/license">IIT Ropar licence</a>.</p>
			</div>
			...
			<div id="main">
				...
				<div class="box alt container">
					<section class="feature left">
						<a href="customer_ui.php" class="image icon fa-signal"><img src="images/pic01.jpg" alt="" /></a>
						<div class="content">
